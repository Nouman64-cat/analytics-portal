...
def list_leads(
    ...
    is_converted: Annotated[Optional[bool], Query()] = None,
    sort: Annotated[
        Literal[
            "last_activity_desc",
            "last_activity_asc",
...
def create_lead(
    ...
    # (so multi-dept candidates get stamped to the dept the user was browsing),
    # then fall back to candidate's primary department_id, then the creator's dept.
    dept_id = current_user.department_id
    if data.active_department_id:
        dept_id = data.active_department_id
