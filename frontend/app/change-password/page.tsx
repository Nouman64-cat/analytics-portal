...
import {
  Loader2, Eye, EyeOff, Wand2, Sparkles, KeyRound, Lock, ShieldCheck,
} from "lucide-react";
...
export default function ChangePasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await authService.changePassword({ new_password: newPassword });
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-10">
          ...
          <div className="max-w-sm">
            ...
            <p className="text-amber-100/55 text-sm leading-relaxed">
              Your temporary spell got you through the gates. Now choose a permanent incantation that&apos;s
              yours alone.
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-[420px] animate-fade-in relative">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-amber-100/55">
              Choose a permanent incantation to continue.
            </p>
          </div>
          ...
          <div className="relative rounded-2xl border border-amber-200/15 bg-white/[0.025] p-6 shadow-[0_8px_40px_rgba(0,0,0,0.45)] backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                ...
                <span>{loading ? "Sealing…" : "Seal Your Password"}</span>
              </button>
            </form>
          </div>
