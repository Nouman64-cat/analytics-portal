import { getProfileColor } from "@/lib/candidateColor";
...
/** A resume profile's avatar circle: colored initials, with the full name as a hover tooltip. */
export default function ProfileAvatar({ profile, size = 24, className = "" }: Props) {
  return (
    <span
      title={profile.name}
